  ...
  return (
    <div id='about' className=' p-4 mt-20'>
      ...
      <div data-aos="fade-up" className='flex flex-col'>
        <h1 className='uppercase mt-2 md:text-left text-center text-[#6722B5] tracking-wider text-xl'>about our agency wings to grow.</h1>
      ...
      <div data-aos="fade-up" className='mt-7 gap-16 text-center flex '>
          <div data-aos="fade-up" className='flex flex-col'>
           <h1 className='text-[#6722B5] font-extrabold text-4xl'>350+</h1>
           <p className='text-gray-600 mt-2 text-base md:text-lg'>Projects Done.</p>
          </div>
          <div data-aos="fade-up" className='flex flex-col'>
           <h1 className='text-[#6722B5] font-extrabold text-4xl'>125+</h1>
